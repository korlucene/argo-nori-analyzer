...
public class POS {
  ...
  public enum Tag {
   ...
   /**
     * Verbal endings
     */
	  EC(100, "Connective ending"),
	    
    EF(100, "Sentense closing ending"),
    
    ETN(101, "Noun transform endings"),
    
    ETM(100, "Modifier transform endings"),
    
    EP(102, "Pre-final ending"),
    ...
    JC(120, "Conjunctive postpositional particle"),
    
    JKB(121, "Advebial postpositional particle"),

    JKC(122, "Complement postpositional particle"),
    
    JKG(123, "Adnominal postpositional particle"),
    
    JKO(124, "Objective postpositional particle"),
    
    JKQ(125, "Quotation postpositional particle"),
    
    JKS(126, "Subjective postpositional particle"),
    
    JKV(127, "Vocative postpositional particle"),
    
    JX(128, "Auxiliary postpositional particle"),
